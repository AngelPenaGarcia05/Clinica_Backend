    ...
    public void enviarRecordatorio(Cita cita) {
        try {
            ...
            String htmlContent = "<!DOCTYPE html>"
                    ...
                    + "<td style='padding: 10px; border: 1px solid #ddd;'>" + cita.getTratamiento().getNombre()
                    + "</td>"
                    + "</tr>"
                    + "<tr>"
                    ...
                    + "<td style='padding: 10px; border: 1px solid #ddd;'>Dr. "
                    + cita.getDentista().getUsuario().getNombres() + " "
                    + cita.getDentista().getUsuario().getApellidoPaterno() + " "
                    + cita.getDentista().getUsuario().getApellidoMaterno() + "</td>"
                    + "</tr>"
                    + "</table>"
            ...
            String htmlContentDentista = "<!DOCTYPE html>"
                    + "<html lang='es'>"
                    + "<head>"
                    + "<meta charset='UTF-8'>"
                    + "<meta name='viewport' content='width=device-width, initial-scale=1.0'>"
                    ...
                    + "</header>"
                    + "<section style='padding: 20px;'>"
                    + "<h2 style='color: #0F2650;'>Hola Dr. " + cita.getDentista().getUsuario().getNombres() + " "
                    + cita.getDentista().getUsuario().getApellidoPaterno() + " "
                    + cita.getDentista().getUsuario().getApellidoMaterno() + "</h2>"
                    ...
                    + "<td style='padding: 10px; border: 1px solid #ddd;'>" + cita.getUsuario().getNombres() + " "
                    + cita.getUsuario().getApellidoPaterno() + " " + cita.getUsuario().getApellidoMaterno() + "</td>"
                    + "</tr>"
                    + "</table>"
                    + "</section>"
                    + "<footer style='background-color: #f4f4f4; color: #666; text-align: center; padding: 10px;'>"
